...
from utils import require_auth, apply_custom_style, show_logo_by_role, show_logo_gaussiana, add_local_sidebar_image
import numpy as np
...
st.write(f"Bienvenido a Modelos Gaussiana : `{st.session_state.user}`.")

#st.header(':orange[Modelos de mezcla gaussiana]') # si se desea cambiar el color del texto
st.header('Modelos de mezcla gaussiana')
