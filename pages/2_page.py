...
from utils import require_auth, apply_custom_style,show_logo_by_role, show_logo_arbol_decision, add_local_sidebar_image
...
st.set_page_config(page_title="Árboles de Regresión",  page_icon="img/logo2.png", layout="wide", initial_sidebar_state="expanded")
...
st.write(f"Bienvenido a Modelo de Regresión : `{st.session_state.user}`.")
