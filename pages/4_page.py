...
from utils import require_auth, apply_custom_style, show_logo_by_role, show_logo_calibracion, add_local_sidebar_image
import base64
...
st.write(f"Bienvenido a Calibración : `{st.session_state.user}`.")
